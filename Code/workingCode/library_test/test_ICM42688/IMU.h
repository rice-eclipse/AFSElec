...
typedef enum
{
    ACCEL_2G = 0b0000 0000,
    ACCEL_4G = 0b0001 0000,
    ACCEL_8G = 0b001 0000,
    ACCEL_16G = 0b0011 0000
} accel_range_t;

typedef enum
{
    GYRO_250DPS = 0b0000 0000,
    GYRO_500DPS = 0b0001 0000,
    GYRO_1000DPS = 0b0010 0000,
    GYRO_2000DPS = 0b0011 0000
} gyro_range_t;
